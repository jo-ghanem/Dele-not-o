...
int main(int argc, char *argv[])
{
  ...
  (start) = (unsigned long)(FullTime.tv_usec + FullTime.tv_sec * 1000000);
   ...
   fields = (struct fields_struct *) ({ void* mem = malloc(sizeof(struct fields_struct)); assert(mem); mem; });;
   fields2 = (struct fields2_struct *) ({ void* mem = malloc(sizeof(struct fields2_struct)); assert(mem); mem; });;
   wrk1 = (struct wrk1_struct *) ({ void* mem = malloc(sizeof(struct wrk1_struct)); assert(mem); mem; });;
   wrk3 = (struct wrk3_struct *) ({ void* mem = malloc(sizeof(struct wrk3_struct)); assert(mem); mem; });;
   wrk2 = (struct wrk2_struct *) ({ void* mem = malloc(sizeof(struct wrk2_struct)); assert(mem); mem; });;
   wrk4 = (struct wrk4_struct *) ({ void* mem = malloc(sizeof(struct wrk4_struct)); assert(mem); mem; });;
   wrk6 = (struct wrk6_struct *) ({ void* mem = malloc(sizeof(struct wrk6_struct)); assert(mem); mem; });;
   wrk5 = (struct wrk5_struct *) ({ void* mem = malloc(sizeof(struct wrk5_struct)); assert(mem); mem; });;
   frcng = (struct frcng_struct *) ({ void* mem = malloc(sizeof(struct frcng_struct)); assert(mem); mem; });;
   iter = (struct iter_struct *) ({ void* mem = malloc(sizeof(struct iter_struct)); assert(mem); mem; });;
   guess = (struct guess_struct *) ({ void* mem = malloc(sizeof(struct guess_struct)); assert(mem); mem; });;
