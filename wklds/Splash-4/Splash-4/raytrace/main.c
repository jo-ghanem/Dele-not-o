 ...
 *			({ void* mem = malloc(); assert(mem); mem; }); failed for some reason.
 *
...
*/
	pid = ({; uint64_t ___x =atomic_fetch_add(&(gm->pid), 1); ; ___x;});
...
int	main(int argc, CHAR *argv[])
	...
	gm = (GMEM *)({ void* mem = malloc(sizeof(GMEM)); assert(mem); mem; });;
