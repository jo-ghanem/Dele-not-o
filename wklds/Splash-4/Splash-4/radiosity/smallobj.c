...
void init_elemvertex(long process_id)
{
    ...
    global->elemvertex_buf = (ElemVertex*)({ void* mem = malloc(MAX_ELEMVERTICES*sizeof(ElemVertex)); assert(mem); mem; });;
...
void init_edge(long process_id)
{
    ...
    global->edge_buf = (Edge*)({ void* mem = malloc(MAX_EDGES*sizeof(Edge)); assert(mem); mem; });;
