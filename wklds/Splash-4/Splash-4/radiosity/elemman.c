...
void init_elemlist(long process_id)
{
    ...
    global->element_buf = (Element*)({ void* mem = malloc(MAX_ELEMENTS*sizeof(Element)); assert(mem); mem; });;
...
void init_interactionlist(long process_id)
{
    ...
    global->interaction_buf = (Interaction*)({ void* mem = malloc(MAX_INTERACTIONS*sizeof(Interaction)); assert(mem); mem; });;
