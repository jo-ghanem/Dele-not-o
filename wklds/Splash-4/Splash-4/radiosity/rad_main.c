...
int main(int argc, char *argv[])
{
    ...
    global = (Global *) ({ void* mem = malloc(sizeof(Global)); assert(mem); mem; }); ;
    if( global == 0 )
        {
    ...
    timing = (Timing **) ({ void* mem = malloc(n_processors * sizeof(Timing *)); assert(mem); mem; });;
    for (i = 0; i < n_processors; i++)
        timing[i] = (Timing *) ({ void* mem = malloc(sizeof(Timing)); assert(mem); mem; });;
...
/*
    ...
    */
    process_id = ({; uint64_t ___x =atomic_fetch_add(&(global->index), 1); ; ___x;});
